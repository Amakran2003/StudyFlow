...
- Kelly a testé plusieurs services d'audiobooks et a découvert LibriVox.
- LibriVox offre des audiobooks gratuits, mais avec quelques limitations.
- La plateforme est gérée par des bénévoles et propose des livres du domaine public.
- Les livres sont disponibles gratuitement, mais des publicités sont présentes sur le site et l'application.
- Il est possible de payer pour supprimer les publicités.
- LibriVox propose plus de 50 000 audiobooks et 263 titres supplémentaires pour un paiement unique de £2.49.
- Les audiobooks disponibles sont généralement anciens, car ils doivent être dans le domaine public.
- Les livres sont enregistrés dans plus de 30 langues par des bénévoles du monde entier.
- Les utilisateurs peuvent télécharger des livres pour les écouter hors ligne.
- Les inconvénients incluent l'absence de livres récents et le fait que les narrateurs ne sont pas toujours professionnels.

## Gros résumé détaillé

Kelly, dans sa vidéo, partage son expérience avec plusieurs services d'audiobooks et présente LibriVox, une plateforme qui propose des audiobooks entièrement gratuits, bien que cela implique certaines limitations. LibriVox est géré par des bénévoles qui enregistrent des livres du domaine public, ce qui signifie que les titres disponibles sont généralement anciens, car pour qu'un livre soit dans le domaine public, l'auteur doit être décédé depuis plus de 70 ans. 

La plateforme offre plus de 50 000 audiobooks gratuits et propose également 263 titres supplémentaires pour un paiement unique de £2.49, ce qui aide à soutenir le service. Bien que l'accès soit gratuit, des publicités sont présentes sur le site et l'application, mais les utilisateurs ont la possibilité de payer un abonnement mensuel de 49p ou annuel de £2.29 pour les supprimer. 

LibriVox se distingue par la diversité des livres disponibles, y compris des œuvres classiques de célèbres auteurs comme Sherlock Holmes, Charles Dickens et Alice au pays des merveilles. De plus, les livres sont enregistrés dans plus de 30 langues, ce qui peut être un atout pour ceux qui cherchent des audiobooks dans d'autres langues. Les utilisateurs peuvent également télécharger des livres pour les écouter sans connexion Internet, ce qui est pratique pour les déplacements. 

Cependant, il existe des inconvénients, notamment le fait que seuls des livres du domaine public sont disponibles, ce qui exclut les
