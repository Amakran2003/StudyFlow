...
- Kelly has been testing different audiobook services and discovered LibriVox.
- LibriVox offers completely free audiobooks recorded by volunteers.
- The audiobooks available are in the public domain, meaning they are older works.
- Over 50,000 free audiobooks are available, with an option to access 263+ additional titles for a one-time fee of £2.49.
- LibriVox adds new public domain books regularly as copyright expires for older works.
- Notable titles available include the Sherlock Holmes series, works by Charles Dickens, and Alice in Wonderland.
- The platform is free to use but includes ads; a subscription to remove ads costs £0.49 monthly or £2.29 yearly.
- Benefits include a wide range of books, availability in over 30 languages, and the ability to download audiobooks for offline listening.
- Drawbacks include the limitation to public domain audiobooks and variability in narrator quality due to volunteer recordings.
- Kelly plans to post

## Gros résumé détaillé

The speaker, Kelly, discusses her recent exploration of various audiobook services, specifically highlighting LibriVox, which offers free audiobooks recorded by volunteers. She invites viewers to subscribe to her channel and shares updates about her content planning, including the launch of a second YouTube channel focused on design and her experiences as a graphic designer.

LibriVox operates as a free platform where users can access over 50,000 public domain audiobooks. These audiobooks are available because they are works whose authors have been deceased for at least 70 years, making them copyright-free. While the selection primarily includes older literature, it features well-known titles like the Sherlock Holmes series, works by Charles Dickens, and Alice in Wonderland, which could be beneficial for students needing resources for school assignments.

Although LibriVox is free, it does include ads to support its volunteer-driven model. Users can opt to pay a small fee to remove these ads, which is significantly lower than subscription services like Audible. The advantages of LibriVox include its extensive library of free audiobooks, recordings in multiple languages, and the ability to download audiobooks for offline listening. However, the limitations include the exclusive availability of public domain titles and the fact that narrations are performed by volunteers, which may vary in quality.

Overall, Kelly emphasizes the value of LibriVox as a resource for classic literature while acknowledging its limitations compared to other audiobook services.
