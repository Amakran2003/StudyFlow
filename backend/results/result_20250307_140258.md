...
- Plus de 50 000 audiobooks sont proposés, avec 263 titres supplémentaires disponibles pour 2,49 £.
- Les livres deviennent disponibles lorsque l'auteur est décédé depuis plus de 70 ans.
- Le service est financé par des publicités, mais une option payante (49p par mois ou 2,29 £ par an) permet de les enlever.
...
- LibriVox est une option intéressante pour ceux qui recherchent des

## Gros résumé détaillé

Kelly, une créatrice de contenu, partage son expérience avec LibriVox, un service qui propose des livres audio gratuits enregistrés par des bénévoles. Elle a récemment exploré divers services de livres audio et a trouvé LibriVox, qui offre plus de 50 000 titres de livres du domaine public. Ces livres sont disponibles gratuitement car ils sont enregistrés par des volontaires et concernent principalement des œuvres dont les auteurs sont décédés depuis plus de 70 ans, ce qui les rend libres de droits. Kelly explique que cela signifie que les livres disponibles sur LibriVox sont souvent des classiques, tels que les œuvres de Sherlock Holmes, Charles Dickens, et Alice au pays des merveilles.

Bien que LibriVox soit gratuit, il existe des options payantes pour supprimer les publicités sur la plateforme. Les utilisateurs peuvent choisir de payer 49 pence par mois ou 2,29 £ par an pour une expérience sans publicité, ce qui est relativement peu coûteux comparé à d'autres services comme Audible. Kelly met en avant plusieurs avantages de LibriVox, notamment la diversité des langues proposées, avec des enregistrements disponibles dans plus de 30 langues, et la possibilité de télécharger des livres audio pour les écouter hors ligne.

Cependant, elle souligne également des inconvénients, tels que la limitation aux livres du domaine public, ce qui signifie que les utilisateurs ne peuvent pas accéder aux nouvelles publications. De plus, les narrateurs étant des
