...
- LibriVox propose des livres audio gratuits, enregistrés par des bénévoles.
- Plus de 50 000 livres audio disponibles, principalement des œuvres du domaine public.
- Les livres doivent être dans le domaine public, c'est-à-dire que l'auteur doit être décédé depuis plus de 70 ans.
- Accès à 263 titres supplémentaires pour un paiement unique de £2.49.
- Possibilité de supprimer les publicités pour £0.49 par mois ou £2.29 par an.
- LibriVox offre des livres audio dans plus de 30 langues.
- Les livres peuvent être téléchargés pour une écoute hors ligne.
- Les narrateurs ne sont pas les auteurs, mais des bénévoles, ce qui peut varier la qualité des voix.
- LibriVox est une bonne option pour ceux qui recherchent des classiques ou des livres pour des travaux scolaires.
- L'application et le site Web sont entièrement gratuits, mais financés par des dons et

## Gros résumé détaillé

Kelly, dans sa vidéo, partage son expérience avec LibriVox, un service qui propose des livres audio gratuits, enregistrés par des bénévoles. Elle souligne que, bien que LibriVox offre un accès à plus de 50 000 livres audio, tous sont des œuvres du domaine public, ce qui signifie qu'ils sont assez anciens. En vertu des lois sur le droit d'auteur, un livre reste protégé jusqu'à 70 ans après la mort de son auteur, ce qui limite le choix aux classiques littéraires.

Kelly explique que, malgré cette restriction, LibriVox peut être une ressource précieuse, notamment pour ceux qui cherchent des œuvres classiques comme les séries Sherlock Holmes, les livres de Charles Dickens ou "Alice au pays des merveilles". Elle mentionne également que ces livres peuvent être utiles pour les étudiants qui pourraient avoir besoin de textes pour leurs études sans avoir à les acheter.

LibriVox est entièrement gratuit, mais le site et l'application comportent des publicités pour soutenir le service. Les utilisateurs peuvent choisir de payer un abonnement modeste pour supprimer les annonces. Kelly compare ce coût à celui d'autres services de livres audio, comme Audible, qui est significativement plus élevé.

Les avantages de LibriVox incluent la gratuité des livres audio, la diversité des titres disponibles et la possibilité d'écouter des livres dans plus de 30 langues. De plus, les utilisateurs peuvent télécharger des livres pour les écouter hors ligne. Toutefois
