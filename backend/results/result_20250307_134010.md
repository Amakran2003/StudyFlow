...
- Les livres disponibles sont dans le domaine public, donc assez anciens.
- Tous les livres sont gratuits, mais des publicités sont présentes sur le site et l'application.
- Pour supprimer les publicités, un abonnement de 49p par mois ou 2,29 £ par an est proposé.
- LibriVox propose plus de 50 000 audiobooks, incluant des classiques comme Sherlock Holmes et Charles Dickens.
- Les livres sont disponibles dans plus de 30 langues.
- Les audiobooks peuvent être téléchargés pour une écoute hors ligne.
- Les livres ne sont pas lus par les auteurs, mais par des bénévoles, ce qui peut varier en qualité.
- LibriVox ne propose pas de livres récents ou sous copyright.
- Le service est entièrement géré par des bénévoles, et les dons aident à son fonctionnement.

## Gros résumé détaillé

Kelly, une créatrice de contenu, partage son expérience avec LibriVox, un service d'audiobooks gratuits. Elle explique que LibriVox est une plateforme gérée par des bénévoles qui enregistrent des livres audio de domaine public, ce qui signifie que ces livres sont disponibles gratuitement car leurs auteurs sont décédés depuis plus de 70 ans. Elle précise que bien que la majorité des titres soient anciens, LibriVox propose plus de 50 000 audiobooks, y compris des classiques tels que les œuvres de Sherlock Holmes et de Charles Dickens.

Kelly mentionne que l'utilisation de LibriVox est totalement gratuite, mais qu'il existe des publicités sur le site et l'application pour soutenir le service. Les utilisateurs peuvent choisir de payer un petit montant pour supprimer ces publicités. En comparaison, elle souligne que ce coût est faible par rapport à d'autres services d'audiobooks comme Audible.

Elle détaille les avantages de LibriVox, tels que la large sélection de titres, la disponibilité dans plusieurs langues et la possibilité de télécharger des livres pour une écoute hors ligne. Cependant, elle note également quelques inconvénients, comme le fait que seuls des livres de domaine public sont disponibles, ce qui exclut les nouvelles publications. De plus, les narrations sont faites par des bénévoles, ce qui peut entraîner des variations dans la qualité des voix et des accents.

Enfin, Kelly encourage les auditeurs à explorer LibriVox, tout en les
