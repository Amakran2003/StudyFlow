...
- Plus de 50,000 audiobooks disponibles sur le site et l'application.
- Les livres sont dans le domaine public, donc assez anciens.
- Coût de 2,49 £ pour accéder à 263 titres supplémentaires.
- Possibilité de payer 0,49 £ par mois ou 2,29 £ par an pour supprimer les publicités.
- Enregistrements disponibles en plus de 30 langues.
- Audiobooks peuvent être téléchargés pour une écoute hors ligne.
- Inconvénients : uniquement des livres du domaine public, pas de nouveautés.
- Les narrateurs sont des bénévoles, ce qui peut varier en qualité.
- LibriVox est une bonne option pour ceux qui recherchent des classiques.

## Gros résumé détaillé

Kelly, une YouTuber passionnée par les livres audio, partage son expérience avec LibriVox, un service qui propose des livres audio gratuits, enregistrés par des bénévoles. Bien que LibriVox soit entièrement gratuit, il y a certaines limitations. Le concept de LibriVox repose sur l'accès à des livres du domaine public, ce qui signifie que seuls les ouvrages dont les auteurs sont décédés depuis plus de 70 ans peuvent être proposés. Cela implique que la majorité des livres disponibles sont des classiques, ce qui peut être un atout pour ceux qui s'intéressent à la littérature ancienne.

LibriVox offre plus de 50 000 livres audio, dont certains titres peuvent être débloqués par un paiement unique de 2,49 £, ce qui aide à soutenir l'organisation. Les livres audio sont disponibles dans plusieurs langues, ce qui est un avantage pour les utilisateurs cherchant des œuvres dans une langue spécifique. De plus, les utilisateurs peuvent télécharger des livres pour les écouter hors ligne, ce qui est pratique pour les déplacements.

Cependant, les utilisateurs ne pourront pas accéder à des livres récents ou à des best-sellers, car LibriVox se limite aux œuvres du domaine public. Les narrations sont réalisées par des bénévoles, ce qui peut entraîner une variation dans la qualité des voix et des accents. Malgré cela, Kelly souligne qu'elle n'a pas rencontré de problèmes majeurs avec les narrateurs et que la qualité est comparable
