...
- Les livres doivent être dans le domaine public, ce qui signifie que l'auteur doit être décédé depuis plus de 70 ans.
- Coût de 2,49 £ pour accéder à des titres supplémentaires, soutenant le service.
- Les audiobooks incluent des classiques comme Sherlock Holmes, Charles Dickens et Alice au pays des merveilles.
- Possibilité d'écouter des livres dans plus de 30 langues.
- Les utilisateurs peuvent télécharger des livres pour les écouter hors ligne.
- Publicité présente sur le site et l'application, avec option de payer 0,49 £ par mois ou 2,29 £ par an pour les supprimer.
- Limitation à des livres du domaine public, pas d'accès à des nouveautés.
- Narration par des bénévoles, qualité variable selon les lecteurs.

## Gros résumé détaillé

Kelly, une créatrice de contenu, partage son expérience avec LibriVox, un service d'audiobooks gratuits. Elle explique que LibriVox, qui fonctionne grâce à des bénévoles, propose des livres audio du domaine public, ce qui signifie que ces livres sont disponibles gratuitement car leurs auteurs sont décédés depuis plus de 70 ans. Bien que cela limite la sélection aux œuvres classiques, Kelly souligne que la plateforme dispose d'une vaste bibliothèque de plus de 50 000 titres, incluant des œuvres notables comme les séries de Sherlock Holmes, Charles Dickens et Alice au pays des merveilles.

Elle précise que LibriVox est accessible via une application ou un site web, et bien que l'utilisation soit gratuite, des publicités y sont présentes pour soutenir le service. Les utilisateurs ont la possibilité de payer un abonnement modique pour supprimer les publicités. Kelly compare ce coût à celui d'autres services d'audiobooks, comme Audible, qui est beaucoup plus cher. Elle mentionne également que LibriVox propose des livres dans plus de 30 langues, ce qui est un atout pour ceux qui cherchent à écouter des livres dans une langue différente.

Cependant, elle note certaines limitations, notamment le fait que les livres ne sont pas narrés par leurs auteurs et que la qualité des narrateurs peut varier. Malgré cela, elle n'a pas rencontré de problèmes majeurs avec les narrateurs qu'elle a écoutés. Kelly conclut en encourageant ses
